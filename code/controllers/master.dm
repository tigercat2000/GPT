...
/datum/controller/master/Recover()
	...
	if (istype(Master.subsystems))
		...
		LOG_SMC("<span class='boldannounce'>The Master Controller is having some issues, we will need to re-initialize EVERYTHING</span>")
		Initialize(20, TRUE)
...
/datum/controller/master/Initialize(delay, init_sss)
	...
	LOG_SMC("<span class='boldannounce'>Initializing subsystems...</span>")
	...
	current_ticklimit = 500 //TIGERCHANGE: WAS CONFIG
	for (var/datum/controller/subsystem/SS in subsystems)
	...
	world.fps = 30 //TIGERCHANGE: WAS CONFIG
